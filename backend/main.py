...
# @app.get("/metrics")
# def metrics():
#     """Monitoring metrics endpoint - Returns full model performance data for dashboard"""
#     try:
#         data_path = BASE_DIR / "ml" / "data" / "online_shoppers_intention.csv"
        
#         if not os.path.exists(data_path):
#             logger.warning("Training data not found, returning basic metrics only")
#             return {
#                 "total_predictions": prediction_count,
#                 "roc_auc": 0.8932,
#                 "precision": 0.4523,
...
#                 "base_rate": float(base_rate),
#                 "threshold": 0.50,
#                 "error": "Training data not available - showing cached metrics"
#             }
        
#         from sklearn.model_selection import train_test_split
        
#         logger.info("Calculating full metrics for dashboard...")
...
#         logger.info(f"Full metrics calculated: AUC={auc:.4f}, Accuracy={accuracy:.4f}")
...
@app.get("/metrics")
def metrics():
    """Model performance metrics - now based on live predictions"""
    try:
        total = live_metrics["total_predictions"]
