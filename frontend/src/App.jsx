...
//                 <input value={form[key]} onChange={(e) => update(key, e.target.value)} style={inputStyle} />
//               </div>
//             ))}
//           </div>

//           {/* Right: Behavior Metrics */}
//           <div style={{ 
//             backgroundColor: "#242424", 
//             borderRadius: "12px", 
//             padding: "24px",
...
// import { useState, useEffect } from "react";  // Change this line (add useEffect)
...
//   // NAVIGATION COMPONENT (same for all pages)
//   const Navigation = () => (
//     <div style={{ 
//       backgroundColor: "#1a1a1a", 
//       padding: "20px", 
...
//   // RENDER PREDICTION PAGE (default)
//   return (
//     <div style={{ 
//       minHeight: "100vh", 
//       backgroundColor: "#1a1a1a", 
...
// import { useState, useEffect } from "react";  // FIXED: Single import with both
// import axios from "axios";
// import Metrics from "./Metrics.jsx";
// import BatchUpload from "./BatchUpload.jsx";
// import PredictionHistory from "./PredictionHistory.jsx";  // ADD THIS
...
//   // ADD THIS: Prediction counter state
//   const [totalPredictions, setTotalPredictions] = useState(0);
  
//   // ADD THIS: Fetch predictions count
//   useEffect(() => {
//     axios.get(`${API_URL}/metrics`)
//       .then(res => setTotalPredictions(res.data.total_predictions))
//       .catch(() => setTotalPredictions(0));
//   }, [currentPage, result]); // Refresh when page changes or prediction made
...
//   // NAVIGATION COMPONENT WITH COUNTER
//   const Navigation = () => (
//     <div style={{ 
//       backgroundColor: "#1a1a1a", 
//       padding: "20px", 
...
//       {/* ADD THIS NEW SECTION: Prediction History */}
//       <div style={{ 
...
// import ABTestSimulator from "./ABTestSimulator.jsx";  // ADD THIS
...
//               <div>
//                 <label style={labelStyle}>Traffic Type ID</label>
//                 <input 
